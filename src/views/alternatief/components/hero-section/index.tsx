...
const HeroSection = () => {
  return (
    <section className="relative flex min-h-[calc(100vh-93.74px)] lg:items-center max-w-[100vw] flex-col-reverse overflow-x-hidden lg:flex-row">
      <div className="container">
        <div className="max-w-[559px] max-lg:pt-10">
          <h1 className="__h1 uppercase text-3xl sm:text-4xl lg:text-5xl">
            Essentials Menu
          </h1>
          <p className="__body_18 mt-3 max-w-[373px] font-medium text-base sm:text-lg">
          ...
          <div className="mt-8 sm:mt-9">
            <h3 className="__h3 font-bold text-lg uppercase sm:text-xl">
              categorieën
            </h3>
...
const DateBox = ({ date, month }: { month: string; date: string }) => {
  return (
    <div className="flex aspect-square min-w-[80px] max-sm:grow lg:min-w-[100px] flex-col justify-between border-r-2 border-black p-2 lg:p-3 text-center text-sm font-bold uppercase sm:text-base">
      <span>{month}</span>
      <span>{date}</span>
    </div>
  );
